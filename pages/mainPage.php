<article id="index">
	<div class="container article">
		<div class="row">
			<div class="col-md-12">
				...
				<div class="newspaper">
					<p>Our vision is to take photo and album sharing to the next generation, making it smarter, more intuitive, and adaptive. Dispersing with irrelevant content and spam, and
					instead tuning the relationship between user and application.</p>
					<p>
					Borrowing from existing scrolling systems, andding additional dimensions, preventing scrolling from being
					limited to up and down.</p>
					<p>
					...
					relevance, what if the parameters that matter to you as a user define the content you see every day?</p>
					<p>
					Content from years ago will flood you with memories you didn't know
					you still had at the more flourish of your finger.</p><p>
					Locations, people, times will present no boundaries for what you see, insted they will help bring to life your past.</p>
					<p>
					But not only your own content will be relevant, combining data from all
					postings will allow you to always see memories from new angles, different perspectives, and here the growth will be exponential.</p>
					<p>
					Imagine sitting with friends and having your best moments flow before you, breaking the norm of one divece
					for one person, now you can sit as many as will fit, and content will always be relevant, not limited.</p>
			  </div>
      		</div>
		</div>
	</div>
	<div id="about" class="container about_us">
		...
		<div class="row article_circle">
			<div class="col-md-3">
				...
				<h3 class="red-border-bottom">SMART ALBUMS</h3>
				<p>
			...
			<div class="col-md-3">
        		...
        		<h3 class="green-border-bottom">3D BROWSING</h3>
				<p>
			...
			<div class="col-md-3">
        		...
        		<h3 class="blue-border-bottom">USER INPUT</h3>
				<p>
			...
			<div class="col-md-3">
        		...
        		<h3 class="yellow-border-bottom">ALGORITHM</h3>
				<p>
	...
	<a id="chevron-index" onclick="ArrowLeftChangePage();" class="chevron chevron_right text-center"><i class="fa fa-chevron-circle-right" aria-hidden="true"></i></a>
